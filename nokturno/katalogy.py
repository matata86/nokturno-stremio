...
SEZNAM = (
    ("sosac.popularni.filmy", "movie", "sosac", "moviesmostpopular",
     "Sosáč — nejpopulárnější filmy", "Sosáč — najpopulárnejšie filmy"),
    ("sosac.nove.filmy", "movie", "sosac", "moviesrecentlyadded",
     "Sosáč — nově přidané filmy", "Sosáč — novo pridané filmy"),
    ("sosac.nove.dabing", "movie", "sosac", "moviesrecentlyadded_dub",
     "Sosáč — nově přidané s CZ dabingem", "Sosáč — novo pridané s CZ dabingom"),
    ("sosac.nove.titulky", "movie", "sosac", "moviesrecentlyadded_subs",
     "Sosáč — nově přidané s CZ titulky", "Sosáč — novo pridané s CZ titulkami"),
    ("sosac.popularni.serialy", "series", "sosac", "tvshowsmostpopular",
     "Sosáč — nejpopulárnější seriály", "Sosáč — najpopulárnejšie seriály"),
